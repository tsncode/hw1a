...
public class Task2Test {
    ...
    public void classesAndFieldsCreated() throws Exception {
        ...
        Class<?> parent = loadClass("co2123.hw1.domain." + c.get("Parent"));
        assertNotNull(parent, "Class " + "co2123.hw1.domain." + c.get("Parent") + " not found");
        ...
        Class<?> child = loadClass("co2123.hw1.domain." + c.get("Child"));
        assertNotNull(child, "Class " + "co2123.hw1.domain." + c.get("Child") + " not found");
